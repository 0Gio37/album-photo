 ...
 */
final class Version20211112192501 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE lien_tag_photo ADD CONSTRAINT FK_D4EB45267E9E4C8C FOREIGN KEY (photo_id) REFERENCES photo (id)');
    }
